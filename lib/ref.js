...
types.uint8 = {
  ...
  indirection: 1,
  get: function get (buf, offset) {
    return exports.readUInt8(buf, offset || 0);
  },
  set: function set (buf, offset, val) {
    return exports.writeUInt8(buf, offset || 0, val);
  }
};
...
exports.PointerBuffer.prototype.writeObject = function writeObject (obj, offset) {
  return exports.writeObject(this, offset, obj);
};
...
exports.PointerBuffer.prototype.readPointer = function readPointer (offset, size) {
  return exports.readPointer(this, offset, size);
};
...
exports.PointerBuffer.prototype.writePointer = function writePointer (ptr, offset) {
  return exports.writePointer(this, offset, ptr);
};
...
exports.PointerBuffer.prototype.writeCString = function writeCString (string, offset, encoding) {
  return exports.writeCString(this, offset, string, encoding);
};
...
exports.PointerBuffer.prototype.writeInt64BE = function writeInt64BE (val, offset) {
  return exports.writeInt64BE(this, offset, val);
};
...
exports.PointerBuffer.prototype.writeUInt64BE = function writeUInt64BE (val, offset) {
  return exports.writeUInt64BE(this, offset, val);
};
...
exports.PointerBuffer.prototype.writeInt64LE = function writeInt64LE (val, offset) {
  return exports.writeInt64LE(this, offset, val);
};
...
exports.PointerBuffer.prototype.writeUInt64LE = function writeUInt64LE (val, offset) {
  return exports.writeUInt64LE(this, offset, val);
};
...
exports.PointerBuffer.prototype.reinterpret = function reinterpret (size, offset) {
  return exports.reinterpret(this, size, offset);
};
...
exports.PointerBuffer.prototype.reinterpretUntilZeros = function reinterpretUntilZeros (size, offset) {
  return exports.reinterpretUntilZeros(this, size, offset);
};
